...
end entity control_unit_32bit;

architecture gate_logic of control_unit_32bit is
...
begin
    ...
    i_bne  <= not i_opcode(5) and not i_opcode(4) and not i_opcode(3)
